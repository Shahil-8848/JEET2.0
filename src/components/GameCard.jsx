...
const GameCard = ({ game, onSelect }) => {
  ...
  return (
    ...
    >
      ...
      <div
        className={`absolute inset-0 bg-gradient-to-br ${theme.gradient} opacity-80 group-hover:opacity-100 transition-all duration-500`}
      >
      ...
      <div className="absolute inset-[2px] bg-gradient-to-br from-gray-950 via-gray-900 to-gray-950 rounded-2xl overflow-hidden">
        ...
        <div className="relative h-full flex flex-col items-center justify-between p-6">
          ...
          <div className="flex-1 flex items-center justify-center">
            <div className="relative">
              ...
              <div className="absolute -inset-4 rounded-full opacity-60 group-hover:opacity-100 transition-opacity duration-500">
                <div
                  className={`absolute inset-0 rounded-full bg-gradient-to-r ${theme.gradient} animate-spin-slow`}
              ...
              {/* Pulse Ring */}
              <div
                className={`absolute -inset-8 rounded-full bg-gradient-to-r ${theme.gradient} opacity-0 group-hover:opacity-30 animate-ping`}
          ...
          <div className="absolute bottom-0 left-0 right-0 h-[2px] overflow-hidden">
            <div
              className={`h-full bg-gradient-to-r ${theme.gradient} opacity-70 group-hover:opacity-100 transition-opacity duration-500`}
            />
            <div
              className={`absolute inset-0 bg-gradient-to-r from-transparent via-white to-transparent opacity-0 group-hover:opacity-60 animate-shimmer-fast`}
            />
          </div>
        </div>
        ...
        <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none overflow-hidden">
          ...
          <div
            ...
            style={{
              background: `linear-gradient(180deg, transparent, ${theme.particleColor}, transparent)`,
            }}
          />
          {/* Bottom Light */}
          <div
